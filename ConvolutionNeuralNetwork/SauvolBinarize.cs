...
{
    public static class SauvolBinarize
    {
        //k - подстройка порога
        //localSquareSize - сторона квадрата для вычисления интегральной суммы
        public static Bitmap Sauvola(Bitmap img, double k = 0.03, int localSquareSize = 15)
        {
